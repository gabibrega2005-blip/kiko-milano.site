(function() {
  ...
  const config = {
    token: 'yGiTNJ5bno87APwJF3m90n0rapR8mi56',
    apiUrl: 'https://api.otimizey.com.br',
    enabledEvents: ["PageView","AddToCart","InitiateCheckout"],
    pixelIds: ["fc2e00da-0a50-4eb5-a417-e58931ba2eb7"],
    checkoutUrlPatterns: ["https://go.zeroonepay.com.br/","https://go.transacaomarketplace.com/","go.transacaomarketplace.com","go.zeroonepay.com.br"]
  };
